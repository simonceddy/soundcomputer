...
const leftButtons = [
  { key: 0, className: 'bg-blue-400' },
  { key: 1, className: 'bg-green-400' },
  { key: 2, className: 'bg-yellow-400' },
  { key: 3, className: 'bg-red-400' },
  { key: 4, className: 'bg-violet-400' },
  { key: 5, className: 'bg-orange-400' },
  { key: 6, className: 'bg-cyan-400' },
  { key: 7, className: 'bg-lime-400' },
];
...
function LeftColButtons() {
  ...
  return (
    <div className="col justify-around h-full items-center p-2 mr-4">
