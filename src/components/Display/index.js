function DisplayContainer({ children, header }) {
  return (
    <div className="h-40 w-72 rounded bg-slate-300 dark:bg-slate-900 text-blue-900 dark:text-blue-200 font-mono mx-2 mt-2 mb-1 flex flex-col justify-start items-start">
