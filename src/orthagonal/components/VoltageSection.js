...
function VoltageSection() {
  return (
    <div className="row ml-[9px] mr-[21px]">
      <div className="col relative">
        ...
        <div className="row justify-start items-start">
          ...
          <div className="col justify-around items-center py-1 ml-[4px] mr-[3px]">
      ...
      <span className="text-[20px] mt-4 ml-0.5 font-sans uppercase">V</span>
    </div>
  );
}
